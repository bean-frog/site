...
const TECH = [
  ...
  {
    title: "Backup Laptop",
    desc: "Dell XPS 7390 with a slightly modified installation of Windows 10.",
    entries: {
      CPU: "Intel i7-1065G7",
  ...
  },
  {
    ...
    desc: "Nvidia AI focused dev kit. Currently experimenting with local AI, including a voice controlled 'Jarvis' system to control the lights in my room.",
    entries: {},
  },
  {
    title: "Lenovo 14W",
